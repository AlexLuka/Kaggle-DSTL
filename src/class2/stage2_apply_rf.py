...
TRAIN_IMAGE_NAMES = ['6010_1_2', '6010_4_4', '6060_2_3', '6070_2_3', '6090_2_0', '6100_1_3',
                     '6100_2_2', '6100_2_3', '6110_1_2', '6110_3_1', '6110_4_0', '6140_1_2',
                     '6140_3_1', '6150_2_3', '6160_2_1', '6170_0_4', '6170_2_4', '6170_4_1']
...
TRAIN_IMAGE_NAMES3 = ['6010_1_2', '6010_4_4', '6040_1_0', '6040_1_3', '6040_4_4', '6070_2_3',
...
MODEL_DIR = 'models'
MODEL_ID = 'model-rf-5'
MODEL_NAME = os.path.join(MODEL_DIR, MODEL_ID, 'the-model.bin')
MASK_DIR = 'masks'
...
def check_on_train(model_, train_images_):
    for train_image_ in train_images_:
        ...
        p_data_ = ss.transform(p_data_)

        p_res_ = model_.predict(p_data_)

        # print 'Summation: ', np.sum(p_res_)

        p_img_ = np.reshape(p_res_, newshape=(h_, w_)) * 255
...
if __name__ == '__main__':
    ...
    if os.path.exists(MODEL_NAME) and not IS_TUNING:
        ...
        ss = pickle.load(open(os.path.join(MODEL_DIR, MODEL_ID, 'scaler.bin'), 'rb'))
    else:
    ...
    check_on_train(model, dft.ImageId.unique())
