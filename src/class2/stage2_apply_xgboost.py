...
TRAIN_IMAGE_NAMES = ['6010_1_2', '6010_4_4', '6060_2_3', '6070_2_3', '6090_2_0', '6100_1_3',
                     ...
                     '6120_2_0', '6120_2_2', '6140_1_2', '6140_3_1', '6150_2_3']
...
def train_model(x_trn, y_trn, x_cv, y_cv):
    ...
    p1_bin[np.where(p1 > 0.5)[0]] = 1
    p2_bin[np.where(p2 > 0.5)[0]] = 1
...
def check_on_train(model_, train_images_):
    for train_image_ in train_images_:
        ...
        p_res_[np.where(p_res_prob_ > 0.5)] = 1.
...
if __name__ == '__main__':
    ...
    for test_image in submission_data.ImageId.unique():
        ...
        prediction_res[np.where(prediction_probability > 0.5)] = 1.
