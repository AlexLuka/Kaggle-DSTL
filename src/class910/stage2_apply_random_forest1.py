...
#
# Subset of images to generate a data
...
def get_image_shape(image_name_):
    image_ = tif.imread(os.path.join('..', '..',
                                     'data',
                                     'sixteen_band',
                                     '{}_{}.tif'.format(image_name_, 'M')))[0, :, :]
    h_, w_ = image_.shape
    del image_
    return h_, w_
...
def collect_data(image_name_, is_train=True):
    ...
    td_ = np.vstack((a16m_0, a16m_1, a16m_2, a16m_3, a16m_4, a16m_5, a16m_6, a16m_7,
                     ...
                     f8, f9, f10, f11, f12,
                     k1, k2)).T
    #                # img_16a_0, img_16a_1, img_16a_2, img_16a_3, img_16a_4, img_16a_5, img_16a_6, img_16a_7)).T
