...
if __name__ == '__main__':
    ...
    for image_name in reversed(train_wkt.ImageId.unique()):
        ...
        img_16m = tif.imread(os.path.join('..', '..',
                                          'data',
                                          'sixteen_band',
                                          '{}_{}.tif'.format(image_name, 'M')))[SLICE_NUMBER, :, :]
        img_16rgb = tif.imread(os.path.join('..', '..',
                                            'data',
                                            'three_band',
                                            '{}.tif'.format(image_name)))[0, :, :]
    ...
    # EXTRACT SHAPES
        ...
        rivers = shapes[shapes.ClassType == 9]
        lakes = shapes[shapes.ClassType == 10]
